  ...
  */
  class eMSCart
  {
	...
	function SignCartSimple($mercahnt_key)
	{
	  ...
	  $this->cart_signature = sha1($string_for_signing);
   ...
   */
	class eMSStatus 
	{
		...
		{
			 require_once('googlelog.php');
			 $log = new GoogleLog('eMSLib/logs/demo_errorlog.txt','eMSLib/logs/demo_messagelog.txt');
			 $log->logLevel = L_ALL;
